            ...
            <Grid container spacing={4}>
              ...
              <Grid size={{ xs: 12, md: 4 }}>
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 3, justifyContent: 'center' }}>
                  <Box sx={{ p: 2, borderRadius: 3, background: primarySoft, color: 'primary.main' }}>
                    <WorkOutline sx={{ fontSize: 32 }} />
                  </Box>
                  <Box>
                    <Typography variant="h3" fontWeight={800} color="primary.main">{yearsExperience}+</Typography>
                    <Typography variant="subtitle1" fontWeight={600} color="text.primary">Years Experience</Typography>
                  </Box>
                </Box>
              </Grid>
              ...
              >
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 3, justifyContent: 'center' }}>
                  <Box sx={{ p: 2, borderRadius: 3, background: secondarySoft, color: 'secondary.main' }}>
                    <FolderSpecial sx={{ fontSize: 32 }} />
                  </Box>
                  <Box>
                    <Typography variant="h3" fontWeight={800} color="secondary.main">{projectsCount}</Typography>
                    <Typography variant="subtitle1" fontWeight={600} color="text.primary">Projects Completed</Typography>
                  </Box>
                </Box>
              </Grid>
              ...
              <Grid size={{ xs: 12, md: 4 }}>
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 3, justifyContent: 'center' }}>
                  ...
                  <Box>
                    <Typography variant="h3" fontWeight={800} color="primary.main">{skillsCount}+</Typography>
                    <Typography variant="subtitle1" fontWeight={600} color="text.primary">Technologies Mastered</Typography>
                  </Box>
                </Box>
              </Grid>
